...
class DrawHpBar():#GraphicsActon
    ...
    def act(self):
        ...
        pygame.draw.rect(inject.instance(IWindowProvider)().get_window(),(255,0,0),(pos[0],pos[1] - 10,20,10))
        hp_persentage = self.__target__.current_hp / self.__target__.hp
        pygame.draw.rect(inject.instance(IWindowProvider)().get_window(),(0,255,0),(pos[0],pos[1] - 10,20 * hp_persentage,10))
